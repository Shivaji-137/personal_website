...
const NoticeBanner = () => {
  ...
  const messages = [
    '🚀 New Astronomical Research Project- Visuaization!!:Galaxies & AGN Multi-Survey Explorer - Streamlit python Based Web apps'
  ];
      ...
      >
        ...
        {messages.map((message, index) => (
          <span key={index} className="mr-8">
            🚀{' '}
            <a href='https://galaxy-visualization-analysis.streamlit.app' target="_blank" className="hover:text-pink-400 no-underline">
              {message}
            </a>
          </span>
        ))}
